...
def load_audio(audiopath,sampling_rate=22000):
    ...
    if lsr != sampling_rate:
        audio=torchaudio.function.resample(audio,lsr,sampling_rate)
    ...
    if uploaded_file is not None:
        if st.button("Analyze Audio"):
            ...
            with col1:
                ...
                result=result.item()
                st.info("Result Proabability: {result}")
            ...
            with col3:
             st.info("Disclaimer")
             st.warning("These classifactions or detection mechanisms are estimated. They should be consider as a strong signal and fair decision")
